...
data_folder = r"c:\TML_Particle_EH5\Project\Project\DataValidation\Crosses"
output_folder = r"c:\TML_Particle_EH5\Project\Project\DataValidation\Clipped_crosses"
trigger_threshold = 8
...
print("\nFærdig. Alle valide målinger er klippet og gemt i 'Clipped_cross' mappen.")
