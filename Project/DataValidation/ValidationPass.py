...
data_folder = r"c:\TML_Particle_EH5\Project\Project\DataValidation\Passes"
output_folder = r"c:\TML_Particle_EH5\Project\Project\DataValidation\Clipped_passes"
trigger_threshold = 6
window_after_trigger = 0.8   # sekunder efter trigger
pre_trigger_time = 0.2       # sekunder før trigger (200 ms)
